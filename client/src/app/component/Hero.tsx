      ...
      <div className="mx-auto max-w-xl lg:max-w-screen-xl">
        <div className="mb-16 text-center lg:mb-0 lg:max-w-lg lg:text-left">
          <div className="mb-6 max-w-xl">
            ...
            <h2 className="mb-6 max-w-lg font-sans text-3xl font-bold tracking-tight text-slate-500 sm:text-5xl sm:leading-snug">
              Find, Buy or Sell car
              <span className="inline-block text-green-500">
                quickly and easyli!
              </span>
            </h2>
            <p className="text-base text-gray-400 md:text-xl">
              Streamline your car buy experience with our effortless process.
            </p>
          </div>
          <div className="flex flex-col items-center justify-center space-y-2 sm:flex-row sm:space-y-0 sm:space-x-2 lg:justify-start">
            <Link
              href="/register"
              className="inline-flex h-12 w-full items-center justify-center rounded-full bg-green-600 px-6 font-medium tracking-wide text-white shadow-md outline-none transition duration-200 hover:bg-green-400 focus:ring sm:w-auto"
            >
              Register now
            </Link>
            <Link
            ...
            <defs>
              <pattern id="img1" x="0" y="0" width="1" height="1">
                <image
                  ...
                  href="https://images.unsplash.com/photo-1503376780353-7e6692767b70?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                />
              </pattern>
            </defs>
